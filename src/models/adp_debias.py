...
class AdvAdapter(BaseModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        adp_name_key = str(sum(num_labels_protected))
        self.encoder.add_adapter("debias"+adp_name_key,adap_config)
        self.encoder.train_adapter("debias"+adp_name_key,adap_config)
